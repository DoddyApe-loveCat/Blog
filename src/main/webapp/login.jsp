        ...
        <div class="container">
            ...
            <div class="col-md-4">
                <div id="login_form_div">
                    ...
                    <form class="form-horizontal" action="${pageContext.request.contextPath}/blogger/login.do"
                          method="post">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="email" class="form-control" id="inputEmail3" placeholder="请输入用户名" name="userName" type="text" value="${blogger.userName}">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
