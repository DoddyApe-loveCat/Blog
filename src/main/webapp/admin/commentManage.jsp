...
<div id="commentReviewOper">
    <a id="commentDelete" class="easyui-linkbutton" iconCls="icon-remove">评论删除</a>
</div>
...
<script type="text/javascript">
    ...
    function stateFormatter(value,row,index) {
        ...
        if(value === 1){
            return "<font color='green'><b>已审核</b></font>";
        }
        if(value === 2){
            return "<font color='red'><b>审核不通过</b></font>";
        }
    }
    ...
    $("#commentDelete").on("click",function(){
        ...
        if(len>0){
            ...
            $.messager.confirm("系统提示","您确定要删除这" + len +"条评论吗?",function (r) {
                if(r){
                    $.get("${pageContext.request.contextPath}/admin/comment/delete.do",{
                        "ids":ids
                    },function (data) {
                        if(data.success){
